                ...
                <div className="container flex flex-wrap items-center justify-center mx-auto space-y-4 sm:justify-between sm:space-y-0">
                    <div className="flex flex-row pr-3 space-x-4 sm:space-x-8">
                        <div className="flex items-center justify-center flex-shrink-0 w-12 h-12 rounded-full dark:bg-violet-400">
                            <img src="https://kansasteachingandleadingproject.org/wp-content/uploads/2020/09/southeast-education-service-center-greenbush-continuous-learning-favicon.png" />
                        </div>
